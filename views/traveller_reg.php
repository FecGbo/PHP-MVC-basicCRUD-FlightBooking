...
<body>
    <div class="container">
        ...
        <div class="right">
            ...
            <form method="POST">
                <h2 style="text-align:center; color:#2d6cdf; margin-bottom: 24px;">Register</h2>
                ...
                <div class="form-group">
                    ...
                    <input type="datetime-local" name="created_at" id="created_at"
                        value="<?php echo htmlspecialchars($created_at ?? ''); ?>">
                    <?php if (isset($errors['created_at'])): ?>
                        <span class="error"><?php echo $errors['created_at']; ?></span>
                    <?php endif; ?>
                </div>
